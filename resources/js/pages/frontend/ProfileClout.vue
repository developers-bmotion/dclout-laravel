    ...
    <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
        <div class="media d-block d-lg-flex">
            ...
            <div class="media-body mg-t-40 mg-lg-t-0 pd-lg-x-10 pb-5">
                <vs-tabs color="#000000" alignment="fixed">
                    <vs-tab @click="skeletonValue = 1" :label="$t('profile-clout.proyectos_presentados')">
                        <div>
                            <vue-good-table
                                ...
                                :columns="columns"
                                :rows="projects"
                                @on-cell-click="onCellTable"
                            >
                                <template slot="table-row" slot-scope="props">
                                    <div v-if="props.column.field == 'state'">
                                        <span v-if="props.row.state == 1" class="badge badge-pill badge-light">Revisión</span>
                                        <span v-if="props.row.state == 2" class="badge badge-pill badge-primary">Publicado</span>
                                        <span v-if="props.row.state == 3" class="badge badge-pill badge-success">Aceptado</span>
                                        <span v-if="props.row.state == 4" class="badge badge-pill badge-danger">Rechazado</span>
                                    </div>
                                    <div v-else-if="props.column.field === 'created_at'">
                                        <p>{{ moment(props.row.created_at).locale("es").format("LL") }}</p>
                                    </div>
                                    <div v-else-if="props.column.field === 'description_short'">
                                        <p style="cursor: pointer">Más información</p>
                                    </div>
                            ...
                            <vs-popup class="holamundo"  title="Lorem ipsum dolor sit amet" :active.sync="popupActivoProfile">
                    ...
                    <vs-tab @click="loadProjectsAprovad" :label="$t('profile-clout.proyectos_aprobados')">
                        ...
                        <div v-else>
                            <p class="text-center">No hay proyectos aprobados</p>
                        </div>
                    </vs-tab>
...
export default {
    ...
    methods: {
        ...
        onCellTable(params){
            ...
            this.description_short = params.row.description_short
